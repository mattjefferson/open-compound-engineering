...
| `julik-frontend-races-reviewer` | `agents/review/julik-frontend-races-reviewer` | `julik-frontend-races-reviewer` | active | Reviews JS/Stimulus code for race conditions |
...
| `kieran-typescript-reviewer` | `agents/review/kieran-typescript-reviewer` | `kieran-typescript-reviewer` | active | Reviews TypeScript code for type safety and modern patterns |
...
| `lint` | `agents/workflow/lint` | `lint` | active | Linting and code quality checks on Ruby and ERB files |
