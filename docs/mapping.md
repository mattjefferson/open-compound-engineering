...
| **Total skills** | **60** | **46** | **17** | **0** | `skills/` |

## Change Log

| Date | Change | Details |
|---|---|---|
| 2026-02-19 | Upstream sync v2.35.1 | Added System-Wide Test Check to `workflows-work` task loop, added System-Wide Impact sections to `plan-standard` and `plan-comprehensive` templates |
