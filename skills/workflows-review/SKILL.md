...
- `docs/plans/*.md` — Plan files created by `/prompts:workflows-plan`. These are living documents that track implementation progress (checkboxes are checked off by `/prompts:workflows-work`).
