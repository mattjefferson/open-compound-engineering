...
Reference the complete [style.md](./references/style.md) for specific rules when in doubt.
...
The complete Every style guide is included in [style.md](./references/style.md). Key areas to focus on:
